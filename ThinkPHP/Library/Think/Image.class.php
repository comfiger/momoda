...
class Image{
     ...
     * @return Object          当前图片处理库对象
     */
    public function thumb($filename, $thumbname, $width, $height, $type = self::IMAGE_THUMB_SCALE){
	 ...
	 * 
	 **/
	public function thumb2($filename, $thumbname, $width, $height, $type = self::IMAGE_THUMB_SCALE){
		$this->img->open($filename);
		$this->img->thumb($width, $height, $type);
		$this->img->save($thumbname);
