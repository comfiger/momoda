...
class UploadFile {//类定义开始
    private $config =   array(
        ...
        'thumbMaxWidth'     =>  '330',// 缩略图最大宽度
        'thumbMaxHeight'    =>  '340',// 缩略图最大高度
    ...
    private function save($file) {
        ...
        if($this->thumb && in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png'))) {
            ...
            if(false !== $image) {
				...
				$counts = count($thumbWidth);
				
                for($i = 0,$len = $counts; $i < $len; $i++) {
                    ...
                    if(1 == $this->thumbType){						
						$imageClass->thumb2($filename, $thumbPath.$thumbname.'.'.$thumbExt, $thumbWidth[$i], $thumbHeight[$i], true);
                    }else{
                        $imageClass->thumb($filename,$thumbPath.$thumbname.'.'.$thumbExt,$thumbWidth[$i],$thumbHeight[$i],true);                        
                    }
